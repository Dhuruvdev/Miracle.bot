...
/* ─────────────────────────────────────────────────────────
   DESIGN TOKENS  (from spec + screenshot)
───────────────────────────────────────────────────────── */
const T = {
  blurple:      "#5865F2",
  blurpleDark:  "#4752C4",
...
const GearIcon = ({ color="rgba(255,255,255,0.5)" }) => (
  <svg width="12" height="12" viewBox="0 0 20 20" fill="none">
    <circle cx="10" cy="10" r="3" stroke={color} strokeWidth="1.8"/>
    <path d="M10 2v2M10 16v2M2 10h2M16 10h2M4.22 4.22l1.42 1.42M14.36 14.36l1.42 1.42M4.22 15.78l1.42-1.42M14.36 5.64l1.42-1.42" stroke={color} strokeWidth="1.8" strokeLinecap="round"/>
  </svg>
);
  ...
  return (
    <div ref={ref} style={{ fontFamily:FONT }}>
      <div style={{
        ...
        letterSpacing:"0.9px", color:"#B5BAC1", marginBottom:8,
      }}>{label}</div>
...
/* USER INFO — NOTE section exactly matching screenshot */
function UserInfoPanel({ note, setNote, editing, setEditing }) {
  return (
    <div style={{ background:T.surface, padding:16, minHeight:180 }}>
      ...
      <div style={{
        fontSize:11, fontWeight:700, textTransform:"uppercase",
        letterSpacing:"0.8px", color:T.label, marginBottom:8,
        fontFamily:FONT,
      }}>Note</div>
      ...
      {editing ? (
        ...
        <div
          ...
          style={{
            ...
            color: note ? T.white : T.muted35,
            cursor:"text", fontFamily:FONT, lineHeight:1.5,
          }}
        >
  ...
  return (
    <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:10 }}>
      ...
      <div onClick={() => onChange(!on)} style={{
        ...
        background: on ? T.blurple : "rgba(255,255,255,0.1)",
...
function LoadingScreen({ server, channel, onDone }) {
...
function SuccessScreen({ server, channel, webhookUrl, onReset }) {
  const svr = SERVERS.find(s => s.id===server);
  const ch  = CHANNELS.find(c => c.id===channel);
  ...
  return (
    <div style={{ background:T.surface, padding:"18px 16px 20px", minHeight:220 }}>
      <div style={{
        background:"rgba(35,165,90,0.12)", border:"1px solid rgba(35,165,90,0.3)",
      ...
      <div
        ...
        style={{
          background:"#1E1F22", border:"1.5px solid rgba(255,255,255,0.07)",
...
function SetupPanel() {
  ...
  const NxtBtn = ({ onClick, label="Next", icon=<ArrowRight/> }) => (
  ...
  const BackLink = ({ onClick }) => (
    <span onClick={onClick} style={{ fontSize:12, color:"#80848E", fontFamily:FONT, cursor:"pointer", transition:"color 0.15s" }}
      onMouseEnter={e=>e.currentTarget.style.color="#B5BAC1"}
      onMouseLeave={e=>e.currentTarget.style.color="#80848E"}>← Back</span>
  );
        ...
        {steps.map((s,i) => {
          ...
          return (
            <div key={s} style={{ display:"flex", alignItems:"center", flex: i<steps.length-1?1:"none" }}>
              <div style={{
                width:20, height:20, borderRadius:"50%", flexShrink:0,
                background: done ? T.blurple : curr ? T.blurple : "rgba(255,255,255,0.08)",
...
/* Tabs match screenshot: User Info / Mutual Servers / Mutual Friends + Setup */
const TABS = [
  { id:"info",    label:"User\nInfo" },
...
export default function DiscordCard() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#111214", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:FONT }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        ::-webkit-scrollbar-thumb{background:#2E2F34;border-radius:4px;}
      ...
      <div style={{
        ...
        <div style={{ background:T.blurple, padding:"16px 16px 0 16px" }}>
          ...
          <div style={{ display:"flex", alignItems:"center", marginBottom:16 }}>
            ...
            <span style={{ fontSize:18, fontWeight:700, color:T.white, lineHeight:1.2, fontFamily:FONT }}>
              just.tiwari
            </span>
          </div>
          ...
          <div style={{
            fontSize:11, fontWeight:700, textTransform:"uppercase",
            letterSpacing:"0.8px", color:T.label,
          ...
          <div style={{
            ...
            {/* 64×64 thumbnail — dark blurple bg with Discord logo */}
            <div style={{
              width:64, height:64, borderRadius:6,
              background:T.blurpleDark,
              display:"flex", alignItems:"center", justifyContent:"center",
              flexShrink:0,
            }}>
              <DiscordLogo size={36}/>
            ...
            <div style={{ flex:1, minWidth:0 }}>
              ...
              <div style={{ fontSize:12, fontWeight:400, color:T.muted60, lineHeight:1.4, fontFamily:FONT, marginBottom:2 }}>Competitive</div>
              <div style={{ fontSize:12, fontWeight:400, color:T.muted60, lineHeight:1.4, fontFamily:FONT, marginBottom:2 }}>Playing Solo ...</div>
              <div style={{ fontSize:12, fontWeight:400, color:T.muted60, lineHeight:1.4, fontFamily:FONT }}>{elapsed} elapsed</div>
            </div>

            {/* Ask to Join button — spec exact */}
            <button
              ...
              style={{
                ...
                background: joinHov ? "rgba(255,255,255,0.10)" : "transparent",
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    alignItems:"center", padding:"10px 4px 0",
                    cursor:"pointer",
                  }}
                  onMouseEnter={e => { if(!active) e.currentTarget.querySelector(".tlbl").style.color = "rgba(255,255,255,0.75)"; }}
                  onMouseLeave={e => { if(!active) e.currentTarget.querySelector(".tlbl").style.color = T.muted50; }}
                >
                  <div className="tlbl" style={{
                    fontSize:13, fontWeight:500,
                    color: active ? T.white : T.muted50,
                    textAlign:"center", lineHeight:1.3,
                    transition:"color 0.15s",
                    fontFamily:FONT,
                    display:"flex", flexDirection:"column", alignItems:"center", gap:2,
                  }}>
                    {t.icon && <GearIcon color={active?"white":T.muted50}/>}
